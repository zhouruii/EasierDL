...
if __name__ == '__main__':
    ...
    crop_and_save_npy(
        ...
        dst_path="/home/disk2/ZR/datasets/OurHSI/256/npy",  # 替换为目标保存路径
        crop_size=128
    )

    convert_to_hdf5(
        src_path="/home/disk2/ZR/datasets/OurHSI/256/npy",  # 裁剪后的NPY块路径
        h5_path="/home/disk2/ZR/datasets/OurHSI/256/npy/dataset.h5"  # 输出的HDF5文件路径
    )
