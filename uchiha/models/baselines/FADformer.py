...
class FADformer(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, patch_size=1,
        ...
        self.patch_embed = PatchEmbed(patch_size=patch_size, in_chans=in_channels,
        ...
        self.patch_unembed = PatchUnEmbed(patch_size=patch_size, out_chans=out_channels,
