...
class DEANet(nn.Module):
    def __init__(self, in_channels=3, base_dim=32):
        ...
        # down-sample
        self.down1 = nn.Sequential(nn.Conv2d(in_channels, base_dim, kernel_size=3, stride=1, padding=1))
        ...
        # level2
        self.fe_level_2 = nn.Conv2d(in_channels=base_dim * 2, out_channels=base_dim * 2, kernel_size=3, stride=1,
                                    padding=1)
        ...
        # level3
        self.fe_level_3 = nn.Conv2d(in_channels=base_dim * 4, out_channels=base_dim * 4, kernel_size=3, stride=1,
                                    padding=1)
        ...
        self.up2 = nn.Sequential(
            ...
            nn.ReLU(True))
        self.up3 = nn.Sequential(nn.Conv2d(base_dim, in_channels, kernel_size=3, stride=1, padding=1))
        # feature fusion
