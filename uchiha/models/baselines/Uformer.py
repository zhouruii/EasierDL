...
class FastLeFF(nn.Module):
    ...
    def __init__(self, dim=32, hidden_dim=128, act_layer=nn.GELU, drop=0.):
        ...
        try:
            ...
            raise ImportError('torch_dwconv should be installed.')
...
class Uformer(nn.Module):
    def __init__(self, img_size=256, in_channels=3, dd_in=3,
        ...
        self.output_proj = OutputProj(in_channel=2 * embed_dim, out_channel=in_channels, kernel_size=3, stride=1)
