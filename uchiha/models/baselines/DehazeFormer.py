...
class DehazeFormer(nn.Module):
    def __init__(self, in_chans=3, out_chans=None, window_size=8,
        ...
        self.out_channel = in_chans + 1 if out_chans is None else out_chans
        ...
        self.patch_unembed = PatchUnEmbed(
            patch_size=1, out_chans=self.out_channel, embed_dim=embed_dims[4], kernel_size=3)
    ...
    def forward(self, x):
        ...
        K, B = torch.split(feat, (1, self.in_channel), dim=1)
