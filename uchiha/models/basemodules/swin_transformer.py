...
from .channel_transformer import Mlp
...
class SwinTransformerLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_head, window_size,
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            layer = SwinTransformerLayer(dim=int(embed_dim * 2 ** i_layer),
...
if __name__ == '__main__':
    ...
    channel = 3
    size = (224, 224)
    x = torch.randn(batch_size, channel, *(size))

    net = SwinTransformer(img_size=224, patch_size=4, in_chans=3, num_classes=1000,
