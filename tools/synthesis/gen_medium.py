...
def generate_medium_rain(num_sets, output_dir='/home/disk2/ZR/datasets/OurHSI/streakV2'):
    """
    批量生成雨纹图片。
    ...
    for i in tqdm(range(num_sets), desc='synthesizing medium rain...'):
        params = {"height": 1024, "width": 1024, "depth": 389, "num_drops": random.randint(2900, 3000),
                  "streak_length": random.randint(35, 40), "wind_angle": random.randint(-180, 180),
                  "wind_strength": random.uniform(0, 0.1), "f": 512}
        # 生成雨纹
