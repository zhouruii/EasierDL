...
RAIN_STREAK_BATCH_V2 = {
    'small': {"height": 512, "width": 512, "depth": 512, "num_drops": random.randint(3000, 3500),
              "streak_length": random.randint(40, 45), "wind_angle": random.randint(-180, 180),
              "wind_strength": random.uniform(0, 0.05), "f": 512},
    'medium': {"height": 512, "width": 768, "depth": 640, "num_drops": random.randint(3300, 3400),
              "streak_length": random.randint(35, 45), "wind_angle": random.randint(-180, 180),
              "wind_strength": random.uniform(0, 0.05), "f": 640},
    'heavy': {"height": 1024, "width": 1024, "depth": 512, "num_drops": random.randint(2700, 2800),
              "streak_length": random.randint(45, 50), "wind_angle": random.randint(-180, 180),
              "wind_strength": random.uniform(0.1, 0.2), "f": 512},
    'storm': {"height": 1024, "width": 1024, "depth": 612, "num_drops": random.randint(3600, 3800),
